 ...
 */
@PWA(name = "Camunda REST-client", shortName = "Camunda REST-client", enableInstallPrompt = false)
@Theme(themeFolder = "camundarest-client", variant = Lumo.DARK)
@PageTitle("Main")
public class MainLayout extends AppLayout {
    ...
    private Component createDrawerContent() {
        H2 appName = new H2("Camunda REST-client");
